...
public class ArticleFolderService extends ServiceAccess<IFolder<Long>, KbFolder> implements IArticleFolderService {
    ...
    public IFolder<Long> addFolder(Long groupId, Long parentResourcePrimKey, Long parentResourceClassNameId,
                                   String name, String description, IGroup<Long> site) throws
        ...
        String result = getHttpPostResponse("knowledge-base-portlet.kbfolder/add-kb-folder", params);
    ...
    public IFolder<Long> getFolder(String urlTitle, Long groupId, Long parentKBFolderId)
        ...
        String result = getHttpPostResponse("knowledge-base-portlet.kbfolder/get-kb-folder-by-url-title", params);
    ...
    @Override
    public IFolder<Long> getFolder(long folderId) throws IOException,
        ...
        String result = getHttpPostResponse("knowledge-base-portlet.kbfolder/get-kb-folder", params);
    ...
    public boolean deleteFolder(IFolder<Long> folder)
        ...
        if (folder != null) {
            ...
            String result = getHttpPostResponse("knowledge-base-portlet.kbfolder/delete-kb-folder", params);
    ...
    /**
     * Not working correctly! Liferay returns method does not exists.
     *
     * @param groupId
     * @param parentKBFolderId
     * @param start
     * @param end
     * @param site
     * @return
     ...
     */
    @Override
    public Set<IFolder<Long>> getFolders(Long groupId, Long parentKBFolderId, int start, int end, IGroup<Long> site) throws JsonParseException, JsonMappingException, IOException,
        ...
        String result = getHttpPostResponse("knowledge-base-portlet.kbfolder/get-kb-folders", params);

        LiferayClientLogger.debug(this.getClass().getName(), "Data retrieved: '" + result + "'.");

        if (result != null) {
            // A Simple JSON Response Read
            Set<IFolder<Long>> folders = decodeListFromJson(result, KbFolder.class);
            FolderPool.getInstance().addElements(folders);
            return folders;
        }
        return null;
    }
    ...
    public Integer getFoldersCount(Long groupId, Long parentKBFolderId, IGroup<Long> site)
        ...
        String result = getHttpPostResponse("knowledge-base-portlet.kbfolder/get-kb-folders-count", params);
